...
This script prepares the input data to pass onto the solving process.
The main function is get_input, which is the function called by the module lrbam.py.
    ...
    ignore_data_words : list, optional
        The data sets containing any of these substrings will be ignored.
        The default is None.
    ...
    s : dict
        Dictionary where each key is a grid cell index and the corresponding value is a list of the indices of the dwellings 
        contained in this grid cell.
"""
...
def create_s_dict(dataset: pd.DataFrame,
    ...
    """
    This function creates the binary encoding s_{d,k} that indicates if dwelling d is in grid cell k as a dictionary 
    where each key is a grid cell index and the corresponding value is a list of the indices of the dwellings contained 
    in this grid cell.
    """
...
def get_input(data_words: list, 
    ...
    """ This function takes the data sets and prepares all the data to be inserted in the solving process. """
    ...
    # Creates new grid cell index column in the dwellings data frame
    ...
    return household_df, dwelling_df, B_k, save_comment, len_H, len_D, idx_to_ids, s