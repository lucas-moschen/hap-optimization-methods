...
This script imports the information about the considered instance of the problem and calls the greedy heuristic.
    ...
    verbose : bool, optional
        If True, detailed information about the operation of the greedy heuristic is provided.
...
import time 
import json
from greedy_heuristic.get_input import get_input 
from common.get_files import get_file_path, get_path_to_folder
from greedy_heuristic.algorithm_greedy import greedy
import numpy as np
import sys 
import psutil
...
class GREEDY_HEURISTIC:
    ...
    def label_final_solution(self):
        ...
        # Give the labels to the final solution and initialize final solution for dwellings
        ...
        # Creates final_solution_dwe which has keys as being dwelling labels
    ...
    def create_save_path(self, dataset_unit: str):
        ...
        description = self.file_title + "_" + w_name + "_greedy_heuristic"
    ...
    def optimize(self):
        ...
        self.final_solution, self.weight, self.hhds_assigned_count = greedy(self.w,
                                                                            self.B_k,
                                                                            self.H,
                                                                            self.D,
                                                                            self.p_h,
